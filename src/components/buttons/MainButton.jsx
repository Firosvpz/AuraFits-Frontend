           ...
           before:border-[#FFD700] before:transition-all before:duration-300 hover:before:border-amber-300 hover:before:scale-110"
            >
                <span class="flex items-center text-[#FFD700] gap-3 relative z-10">
                    <svg stroke="#FFD700" fill="none" viewBox="0 0 24 24" class="w-6 h-6 transition-transform duration-300 group-hover:scale-110">
                        <path
                ...
                <div
                    class="absolute inset-0 rounded-xl opacity-40 group-hover:opacity-70 transition-opacity duration-500 "
                ></div>
                <div
                    class="absolute -left-full top-0 h-full w-full group-hover:translate-x-[200%] transition-transform duration-600 ease-out"
                ></div>
            </button>
