          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 max-w-8xl mx-auto">
            {membershipPlans.map((plan, index) => (
              ...
              >
                ...
                {/* Card */}
                <div
                  className="relative h-[480px] w-full max-w-[340px] mx-auto rounded-2xl border overflow-hidden backdrop-blur-sm transition-all duration-700 group-hover:backdrop-blur-md group-hover:scale-105 group-hover:-translate-y-2 group-hover:shadow-2xl"
                  style={{
