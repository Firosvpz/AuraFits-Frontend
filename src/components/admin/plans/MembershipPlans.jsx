                ...
                <div className="max-w-7xl mx-auto space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div className=" border border-gray-800 rounded-lg p-4">
                            <div className="text-sm font-medium text-gray-400 mb-2">Total Plans</div>
                            <div className="text-2xl font-bold text-white">{plans.length}</div>
                        </div>
                        <div className=" border border-gray-800 rounded-lg p-4">
                            <div className="text-sm font-medium text-gray-400 mb-2">Active Plans</div>
                            <div className="text-2xl font-bold text-green-400">{plans.filter((p) => p.status === "active").length}</div>
                        </div>
                        <div className=" border border-gray-800 rounded-lg p-4">
                            <div className="text-sm font-medium text-gray-400 mb-2">Total Subscribers</div>
                        ...
                        <div className="p-6">
                            ...
                            <div className="rounded-md border border-gray-800 overflow-hidden">
                                <table className="w-full">
                                    <thead>
                                        <tr className="border-b border-gray-800 bg-gray-800/30">
                                            <th className="text-left p-4 text-gray-300 font-medium">Plan Name</th>
                                            ...
                                            <th className="text-left p-4 text-gray-300 font-medium">Subscribers</th>
                                    ...
                                    <tbody>
                                        {filteredPlans.map((plan) => (
                                            <tr key={plan.id} className="border-b border-gray-800 hover:bg-gray-800/30 transition-colors">
                                                <td className="p-4">
                                                    <div>
                                                ...
                                                <td className="p-4 text-white font-medium">${plan.price}</td>
                                                <td className="p-4">
                                                    <span
                                ...
                                {filteredPlans.length === 0 && (
                                    <div className="text-center py-8 text-gray-400">No plans found matching your criteria.</div>
                                )}
                            </div>
                        </div>
                    </div>
