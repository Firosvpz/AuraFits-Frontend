        ...
        <div className="relative z-10 w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="flex flex-col justify-center">
            <div className="relative">
              ...
              <div className="relative  backdrop-blur-sm  shadow-xl rounded-2xl p-8 sm:p-10 lg:p-12 transition-all duration-500 ">
                {/* Content */}
                <div className="relative z-10">
                  ...
                  <p
                    className="mt-6 text-lg text-gray-300 leading-relaxed transition-all duration-800 poppins ease-out"
                    style={{
                      transform: isLoaded ? "translateY(0)" : "translateY(20px)",
                      opacity: isLoaded ? 1 : 0,
