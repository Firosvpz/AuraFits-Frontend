...
import { Users, Target, Lightbulb, Award, ArrowUpRight, Sparkles } from "lucide-react"
...
const About = () => {
    ...
    return (
        <div className="min-h-screen pt-20  text-yellow-300 overflow-hidden relative">
            ...
            <motion.div style={{ y }} className="relative z-10 px-4 md:px-8 lg:px-16 pb-20 pt-12">
                <motion.div
                            ...
                            <div className="relative h-full">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="text-white relative z-10">{card.icon}</div>
                                            {/* Inner Glow */}
                ...
                >
                    <div className="relative">
                        ...
                        <div className="relative bg-black/60 backdrop-blur-2xl border border-white/10 rounded-[2rem] p-12 md:p-16 overflow-hidden">
                            ...
                            >
                                We believe in the power of collaboration, creativity, and cutting-edge technology. Our journey is
                                defined by our commitment to excellence and our passion for creating solutions that make a real
