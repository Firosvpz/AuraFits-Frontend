...
const MainContent = () => {
  ...
  return (
    <main className="min-h-screen pt-5">
      {/* Hero Section */}
      <section className="relative min-h-screen max-w-9xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-16 flex items-center overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="relative   shadow-xl rounded-2xl p-8 sm:p-10 lg:p-12 transition-all duration-500 ">
                ...
                <div className="relative ">
                  ...
                  >
                    Transform your body and mind with our scientifically-proven
                    fitness programs designed for lasting results.
                  </p>
            ...
            <div className="relative w-full max-w-sm lg:max-w-md ">
              ...
              <div className="relative p-4 border-2 border-[#FFD700] rounded-2xl shadow-[0_0_50px_rgba(255,215,0,0.6)] overflow-hidden">
                ...
                <div className="absolute top-6 right-6 bg-black/90 backdrop-blur-sm rounded-lg p-3 border border-[#FFD700] shadow-[0_0_20px_rgba(255,215,0,0.5)] animate-float-cyber">
                  <div className="text-lg font-bold text-[#FFD700] animate-counter-up">
                    98%
                  </div>
                ...
                <div
                  ...
                  style={{ animationDelay: "1s" }}
                >
                  <div className="text-lg font-bold text-[#FFF500] animate-counter-up">
                    10K+
                  </div>
