...
const Logo = () => {
  return (
    <>
       <div className='cursor-pointer hover:scale-105' style={{
      display: 'flex',
      alignItems: 'center',
      gap: '10px',
      ...
      <svg className='rotate-[120deg]' width="40" height="40" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <span style={{ color: '#FFF500', letterSpacing: '1px' }}>Aura<span style={{ color: '#FFD700' }}>Fits</span></span>
    </div>
    </>
  );
};
